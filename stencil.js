...
const sizes = {
  width: document.getElementById("rightSide").clientWidth,
  height: document.getElementById("rightSide").clientHeight
};
...
window.addEventListener("resize", () => {
  sizes.width = document.getElementById("rightSide").clientWidth;
  sizes.height = document.getElementById("rightSide").clientHeight;
